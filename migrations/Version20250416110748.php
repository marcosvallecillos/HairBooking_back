 ...
 */
final class Version20250416110748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuario_producto_favorito (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, producto_id INT NOT NULL, is_favorite TINYINT(1) NOT NULL, INDEX IDX_EB86FC90DB38439E (usuario_id), INDEX IDX_EB86FC907645698E (producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
