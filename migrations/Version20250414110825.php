 ...
 */
final class Version20250414110825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE productos (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, image VARCHAR(255) NOT NULL, cantidad INT NOT NULL, is_favorite TINYINT(1) NOT NULL, inside_cart TINYINT(1) NOT NULL, fecha DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservas (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, servicio VARCHAR(255) NOT NULL, peluquero VARCHAR(255) NOT NULL, dia DATE NOT NULL, hora TIME NOT NULL, INDEX IDX_AA1DAB01DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
